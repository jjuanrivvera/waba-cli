...
```
waba send cta-url <body> [flags]
```

### Examples

```
  waba send cta-url --to 573001112233 "See your invitation" --display-text "Abrir" --url https://invitas.co/e/abc
```

### Options

```
      --display-text string   button label
      --footer string         optional footer text
      --header string         optional header text
  -h, --help                  help for cta-url
